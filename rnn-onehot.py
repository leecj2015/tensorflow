...
x_train=[id_to_onehot[word_to_id['a']],id_to_onehot[word_to_id['b']],id_to_onehot[word_to_id['c']],id_to_onehot[word_to_id['d']],id_to_onehot[word_to_id['e']]]
